...
class Sick extends Component {
    render() {
        return (
          ...
          <Circle cx="32" cy="32" r="30" fill="#ffdd67"/><G fill="#664e27">
          <Circle cx="43.5" cy="30.3" r="5"/><Circle cx="20.5" cy="30.3" r="5"/>
          </G><G fill="#917524">
          <Path d="m25.6 15.2c-3.2 2.7-7.5 3.9-11.7 3.1-.6-.1-1.1 2-.4 2.2 4.8.9 9.8-.5 13.5-3.6.5-.5-1-2.1-1.4-1.7"/>
          <Path d="m50.1 18.2c-4.2.7-8.5-.4-11.7-3.1-.4-.4-2 1.2-1.4 1.7 3.7 3.2 8.7 4.5 13.5 3.6.7-.2.2-2.3-.4-2.2"/></G>
          ...
          <Path d="m20.5 43.2l-1.9 2.7-.9-.5 1.9-2.8z"/><Path d="m23 44.9l-1.9 2.6-.8-.5 1.8-2.6z"/>
          <Path d="m25.4 46.6l-1.6 2.4-.9-.6 1.7-2.3z"/><Path d="m27.9 48.3l-1.5 2.2-.9-.6 1.5-2.1z"/></G>
